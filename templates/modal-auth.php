        ...
        <div class="modal-content">
            <div class="auth">
                ...
                <form action="../script/auth.php" method="post">
                    ...
                    <input id="auth-email-confirm" type="text" placeholder="Подтвердите почту" name="confirm-email" class="form-control-plaintext"><br>
            ...
            <div class="reg">
                ...
                <form action="../script/reg.php" method="post">
                    <input id="reg-email" type="text" placeholder="Почта" name="email" class="form-control-plaintext" ><br>
